...
('Java', 'Activa','5','resources/colecciones/Java/java.JPEG', 'Coleccion de java, uno de los lenguajes de programacion mas importantes actualmente'), 
('C', 'Activa', '5', 'resources/colecciones/C/C.JPG', 'Coleccion de C, el lenguaje por excelencia para programacion de Sistemas Operativos');
...
INSERT INTO `CROMOS` (`ID`, `Nombre`, `Coleccion`, `RutaImagen`, `Precio`, `Cantidad`, `Descripcion`, `DatoInteresante`, `Frecuencia`) VALUES 
	(NULL, 'ArrayIndexOutOfBoundsException', 'Java', 'resources/cromos/Java/ArrayIndexOutOfBoundsException.JPG', '1', '3', 'Se lanza para indicar que se esta intentando acceder a una posicion fuera de un array. El indice elegido es negativo o mayor que la longitud del array', 'Parece que te falta algun elemento en el array amigo', 'Comun'),
	(NULL, 'ClassCastException', 'Java', 'resources/cromos/Java/ClassCastException.JPG', '2', '2', 'Se lanza para indicar que el código ha intentado convertir un objeto en una subclase de la que no es una instancia.', 'Parece ser que no eres muy de OOP', 'Raro'),
	(NULL, 'IllegalArgumentException', 'Java', 'resources/cromos/Java/IllegalArgumentException.JPG', '2', '2', 'Lanzada cuando a un metodo se le pasa un argumento ilegal o inapropiado', 'Creo que deberias conocer mejor los metodos que has programado campeon', 'Raro'),
	(NULL, 'IllegalStateException', 'Java', 'resources/cromos/Java/IllegalStateException.JPG', '3', '1', 'Lanzada cuando se llama a un método en un momento inapropiado o ilegal. Esto quiere decir que el entorno de Java no se encuentra en el estado adecuado para la ejecucion de este metodo', 'Que habras hecho para que te pase esto... Surrealista', 'Excepcional'),   
	(NULL, 'NullPointerException', 'Java', 'resources/cromos/Java/NullPointerException.JPG', '1', '3', 'Es una excepcion de tipo RuntimeException. En Java, un valor especial null se puede asignar a un objeto. Se lanzara esta excepcion cuando la aplicacion trate de usar una referencia que apunte a null', 'No te preocupes, nos ha pasado a todos...', 'Comun'),
	(NULL, 'NumberFormatException', 'Java', 'resources/cromos/Java/NumberFormatException.JPG', '2', '2', 'Se lanza para alertar de que la aplicacion ha intentado convertir una cadena de texto a algun formato numerico, sin que esta cumpla las condiciones para poder hacerlo', 'Esto te pasa por no usar Python', 'Comun'),
	(NULL, 'AssertionError', 'Java', 'resources/cromos/Java/AssertionError.JPG', '1', '3', 'Se lanza al detectar un fallo en alguna afirmacion (assertion), generalmente en el codigo de test de la aplicacion', 'Por lo menos has hecho tests, ni tan mal', 'Comun'),
	(NULL, 'ExceptionInInitializerError', 'Java', 'resources/cromos/Java/ExceptionInInitializerError.JPG', '3', '1', 'Lanzada cuando ocurre alguna excepcion inesperada durante la inicializacion de una variable estatica o la evaluacion de un inicializador estatico', 'No me ha pasado en la vida', 'Excepcional'),    
	(NULL, 'StackOverflowError', 'Java', 'resources/cromos/Java/StackOverflowError.JPG', '1', '3', 'Lanzada cuando una aplicacion intenta acceder a recursos en memoria que no le han sido asignados. Los permisos concedidos a esta aplicacion por el sistema no permitiran dicho acceso', 'Este error da nombre a la Biblia de la informatica', 'Comun'),    
	(NULL, 'NoClassDefFoundError', 'Java', 'resources/cromos/Java/NoClassDefFoundError.JPG', '2', '2', 'Lanzada cuando la Java Virtual Machine no consigue encontrar un fichero .class concreto durante la ejecucion que si fue compilado previamente', 'Vuelve a compilar, crack!', 'Raro');    
 
 #INSERTAR LOS CROMOS DE LA COLECCCION DE C
INSERT INTO `CROMOS` (`ID`, `Nombre`, `Coleccion`, `RutaImagen`, `Precio`, `Cantidad`, `Descripcion`, `DatoInteresante`, `Frecuencia`) VALUES 
	(NULL, 'var_undeclared', 'C', 'resources/cromos/C/var_undeclared.JPG', '1', '3', 'Mostrado cuando en el codigo desarrollado en C se utiliza una variable que no ha sido declarada previamente', 'Vayamos por partes... Lo primero es delcarar las variables!', 'Comun'),
	(NULL, 'implicit_declaration_of_function', 'C', 'resources/cromos/C/implicit_declaration_of_function.JPG', '1', '3', 'Mostrado cuando en el codigo desarrollado en C se utiliza una funcion que no ha sido declarada previamente o que ha sido definida posterior a su llamada', 'Estas programando en C melon, esto no es Java', 'Comun'),
	(NULL, 'undefined_reference_to', 'C', 'resources/cromos/C/undefined_reference_to.JPG', '2', '2', 'Mostrado cuando en el codigo desarrollado en C se utiliza una funcion propia de una libreria que no se ha indicado al compilar', 'Compilando en consola es lo que hay', 'Raro'),
	(NULL, 'conflicting_types_for', 'C', 'resources/cromos/C/conflicting_types_for.JPG', '2', '2', 'Normalmente se muestra cuando en la declaracion de una funcion los parametros entran en conflicto con los de su definicion', 'Copia y pega, pones ; al final y listo!', 'Raro'),
	(NULL, 'segmentation_fault(core_dumped)', 'C', 'resources/cromos/C/segmentation_fault(core_dumped).JPG', '1', '3', 'Mostrado cuando una aplicacion intenta acceder a recursos en memoria que no le han sido asignados. Los permisos concedidos a esta aplicacion por el sistema no permitiran dicho acceso', 'Cuidado con el core dump que la puedes liar parda', 'Comun'),    
	(NULL, 'integer_from_pointer_without_a_cast', 'C', 'resources/cromos/C/integer_from_pointer_without_a_cast.JPG', '1', '3', 'Cuando se intenta utilizar un puntero en un contexto en el que se espera un entero, se muestra este error', 'Aunque lo diga el error, no tiene pinta de que castear sea la solucion', 'Comun'),    
	(NULL, 'dereferencing_pointer_to_incomplete_type', 'C', 'resources/cromos/C/dereferencing_pointer_to_incomplete_type.JPG', '3', '1', 'Aparece cuando se utiliza un puntero a una estructura de datos para acceder a alguno de sus campos, pero el compilador no tiene información suficiente sobre esa estructura de datos', 'Puede que tengas la definicion de la estructura en otro fichero, espabila!', 'Excepcional'),  
	(NULL, 'unused_variable', 'C', 'resources/cromos/C/unused_variable.JPG', '1', '3', 'Advertencia que se muestra cuando se ha declarado una variable que no se usa posteriormente', 'Si el programa funciona, borra sin miedo', 'Comun'),  
	(NULL, 'syntax_error_before_token', 'C', 'resources/cromos/C/syntax_error_before_token.JPG', '1', '3', 'Hay algun error en algun punto anterior al token que se te indica, normalmente previo a ; o }', 'El error puede estar en cualquier sitio anterior al token, a buscar!', 'Comun'),  
	(NULL, 'invalid_operands', 'C', 'resources/cromos/C/invalid_operands.JPG', '2', '2', 'Este error indica que se esta intentando operar con dos operandos que no son compatibles entre si para dicha operacion', 'Procura fijarte en los tipos de las variables que operas', 'Raro'); 
